...
exports.analyseLetterImage = analyseLetterImage;
...
function analyseLetterImage(base64Image) {
...
Content of the letter:`, // <-- The model understands the image is the content
                ...
                case 1:
                    result = _g.sent();
                    text = (_f = (_e = (_d = (_c = (_b = (_a = result.response) === null || _a === void 0 ? void 0 : _a.candidates) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.content) === null || _d === void 0 ? void 0 : _d.parts) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.text;
                    return [2 /*return*/, text !== null && text !== void 0 ? text : 'Could not extract or summarize text from the image.'];
            }
        });
    });
}
