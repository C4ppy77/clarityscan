...
exports.fetchBase64Image = fetchBase64Image;
// Adjusted for Node.js environment
var buffer_1 = require("buffer"); // Node.js built-in module
function fetchBase64Image(url) {
    return __awaiter(this, void 0, void 0, function () {
        var response, arrayBuffer, buffer, base64, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error("Error fetching or converting image:", error_1);
